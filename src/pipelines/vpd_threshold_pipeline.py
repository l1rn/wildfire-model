...
class VPDThresholdPipeline:
    ...
    def plot_collage(self, year=2022):
        ...
        months = [5, 7, 8]
        month_names = {5: "May", 7: "July", 8: "August"}
        ...
        if im is not None:
            ...
            cbar.set_label("VPD Wildfire Risk Level", fontsize=12, fontweight="bold")
